...
class TasksViewModel {
  ...
  TasksViewModel(this._repository, this._taskWithProjectUseCase, this._projectsRepository);
  ...
  void initialize() {
    ...
    _combineSubscription = Rx.combineLatest2<List<TaskWithProject>, TaskFilterView, void>(
      _taskWithProjectUseCase.call(), // Слушаем Use Case со склеенными проектами
    ...
    if (filteredTasks.isEmpty) {
      ...
      _uiStateController.add(
        TasksLoaded(
          ...
          tasks: filteredTasks, // Важно: TasksLoaded теперь должен принимать List<TaskWithProject>
        ),
      );
    }
  }
  ...
  Stream<List<Project>> watchProjects() => _projectsRepository.watchAllProjects();
