...
void main() {
  group('MyApp', () {
    testWidgets('renders MaterialApp with dark theme', (tester) async {
      ...
      final dashboardLayoutRepo = DashboardLayoutRepository();
      ...
      dc.dashboardLayoutRepository = dashboardLayoutRepo;
      dc.dashboardViewModel = DashboardViewModel(dashboardLayoutRepo);
